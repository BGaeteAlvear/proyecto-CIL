...
@section('content-subtitle', 'Subcategoría')
                ...
                <div class="box-body">
                    <div id="toolbar" class="btn-group">
                        <button data-toggle="modal" data-target="#modal-create" class="btn btn-success"><i
                                    class="fa fa-plus"></i> Nuevo Subcategoría
                        </button>
                    </div>
                    <table
                            id="table"
                    ...
                    >
                        ...
                        <tr>
                            ...
                            <th data-field="node_category.name" data-sortable="true">Categoría</th>
            ...
            <form method="post" id="form-create">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Nuevo Subcategoría</h4>
                    </div>
    ...
    <script>
        ...
        function ajaxRequest(params){
            ...
            $.ajax({
                ...
                url: "{{ route('node-subcategories.all') }}",
        ...
        $(function () {
            $('#form-create').submit(function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '{{route('node-subcategories.store')}}',
                    data: dataForm,
                    success: function (data) {
        ...
        $(function () {
            $('#form-edit').submit(function (e) {
                ...
                e.preventDefault();
                var url = '{{route('node-subcategories.update')}}';
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: dataForm,
                    success: function (data) {
                        ...
                        if(data.status === 'success'){
                            showToastSuccess(data.message);
                            showToastWarning('Tenga en cuenta que la subcategoría que ha modificado puede estar siendo utilizado por nodos y este cambio será reflejado en estos.');
        ...
        function changeStatusToggle(rowId){
            ...
            $.ajax({
                type: 'POST',
                url: '{{route('node-subcategories.change-status')}}',
                data: {
                    _token : '{{ csrf_token() }}',
                    id : item.id,
                    active : itemStatus
                ...
                success: function (data) {
                    ...
                    if(data.status === 'success'){
                        ...
                        showToastSuccess('Se ha ' + status + ' la subcategoría ' + data.entity.name);
                        if(status == 'desactivado'){
                            showToastWarning('Tenga en cuenta que la subcategoría que ha deshabilitado puede estar siendo utilizado por nodos y este dejará de aparecer como una opción seleccionable.');
                        }
                        updateRow(items.findIndex(item => item.id == data.entity.id), data.entity);
                    }
                },
        ...
        function remove(id){
            ...
            swal({
                title: '¿Estas seguro?',
                text: "Si eliminas esta subcategoría de nodo se perderán todas las relaciones actuales.",
                type: 'question',
                ...
                if (result.value) {
                    ...
                    var url = '{{route('node-subcategories.destroy')}}';
                    $.ajax({
                        type: 'POST',
                        url: url,
                        data: {
                        ...
                        success: function (data) {
                            ...
                            if(data.status === 'success'){
                                showToastSuccess(data.message);
                                showToastWarning('Tenga en cuenta que la subcategoría que ha eliminado ya no puede ser referenciado.');
                                $('#table').bootstrapTable('refresh');
                            }
                        },
                        error: function (error) {
