...
@section('content-subtitle', 'Tipos de Juegos')

@section('breadcrumb')
    <li>Configuración</li>
    <li class="active">Tipos de Juegos</li>
@endsection
                ...
                <div class="box-body">
                    <div id="toolbar" class="btn-group">
                        <button data-toggle="modal" data-target="#modal-create" class="btn btn-success"><i
                                    class="fa fa-plus"></i> Nueva Tipo de Juego
                        </button>
                    </div>
                    <table
                            id="table"
            ...
            <form method="post" id="form-create">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Nueva Tipo de Juego</h4>
                    </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" onclick="dissmisModal('#form-edit','#modal-edit')" aria-label="Close">
                            <span aria-hidden="true">×</span></button>
                        <h4 class="modal-title">Editar Tipo de Juego</h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
    ...
    <script>
        ...
        $(function () {
            $('#form-edit').submit(function (e) {
                ...
                e.preventDefault();
                var url = '{{route('game-types.update')}}';
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: dataForm,
        ...
        function changeStatusToggle(rowId){
            ...
            $.ajax({
                type: 'POST',
                url: '{{route('game-types.change-status')}}',
                data: {
                    _token : '{{ csrf_token() }}',
                    id : item.id,
                    active : itemStatus
        ...
        function remove(id){
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    var url = '{{route('game-types.destroy')}}';
                    $.ajax({
                        type: 'POST',
                        url: url,
                        data: {
