...
@section('content-subtitle', 'Categoría de Nodos')

@section('breadcrumb')
    <li><a href="{{ route('config') }}">Configuración</a></li>
    <li class="active">Categoría de Nodos</li>
@endsection
                ...
                <div class="box-body">
                    <div id="toolbar" class="btn-group">
                        <button data-toggle="modal" data-target="#modal-create" class="btn btn-success"><i
                                    class="fa fa-plus"></i> Nueva Categoría de Nodo
                        </button>
                    </div>
                    <table
                            id="table"
            ...
            <form method="post" id="form-create">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Nueva Categoria de Nodo</h4>
                    </div>
            ...
            <form method="post" id="form-edit">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span></button>
                        <h4 class="modal-title">Editar Categoria de Nodo</h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
    ...
    <script>
        ...
        $(function () {
            $('#form-create').submit(function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '{{route('node-categories.store')}}',
                    data: dataForm,
                    success: function (data) {
        ...
        $(function () {
            $('#form-edit').submit(function (e) {
                ...
                e.preventDefault();
                var url = '{{route('node-categories.update')}}';
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: dataForm,
        ...
        function changeStatusToggle(rowId){
            ...
            $.ajax({
                type: 'POST',
                url: '{{route('node-categories.change-status')}}',
                data: {
                    _token : '{{ csrf_token() }}',
                    id : item.id,
                    active : itemStatus
        ...
        function remove(id){
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    var url = '{{route('node-categories.destroy')}}';
                    $.ajax({
                        type: 'POST',
                        url: url,
                        data: {
