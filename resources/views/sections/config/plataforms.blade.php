...
@section('content-subtitle', 'Plataformas')
                ...
                <div class="box-body">
                    <div id="toolbar" class="btn-group">
                        <button data-toggle="modal" data-target="#modal-create" class="btn btn-success"><i
                                    class="fa fa-plus"></i> Nueva Plataforma
                        </button>
                    </div>
                    <table
                            id="table"
    ...
    <script>
        ...
        $(function () {
            $('#form-edit').submit(function (e) {
                ...
                e.preventDefault();
                var url = '{{route('plataforms.update')}}';
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: dataForm,
        ...
        function changeStatusToggle(rowId){
            ...
            $.ajax({
                type: 'POST',
                url: '{{route('plataforms.change-status')}}',
                data: {
                    _token : '{{ csrf_token() }}',
                    id : item.id,
                    active : itemStatus
        ...
        function remove(id){
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    var url = '{{route('plataforms.destroy')}}';
                    $.ajax({
                        type: 'POST',
                        url: url,
                        data: {
